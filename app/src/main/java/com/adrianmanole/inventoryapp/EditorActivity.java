...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void initializeUIElements() {
        mTextViewInfo = (TextView) findViewById(R.id.text_required_fields);
        mTextViewError = (TextView) findViewById(R.id.text_error_invalid_entry);
        mTextViewProduct = (TextView) findViewById(R.id.text_label_product);
        mTextViewPrice = (TextView) findViewById(R.id.text_label_price);
        mTextViewStock = (TextView) findViewById(R.id.text_label_stock_quantity);
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setPositiveButton(R.string.dialog_action_yes, discardButtonClickListener);
    ...
    public void addProduct() {
        ...
        if (getEditorInputs()) {
            ...
            values.put(InventoryEntry.COLUMN_QUANTITY, productStock);
            values.put(InventoryEntry.COLUMN_IMAGE, imagePath);
    ...
    public boolean getEditorInputs() {
        ...
        if (TextUtils.isEmpty(product)) {
            ...
            mEditTextProduct.setError(getString(R.string.error_product_name_invalid));
            return false;
        }
        ...
        if (TextUtils.isEmpty(strPrice)) {
            ...
            mEditTextProductPrice.setError(getString(R.string.error_price_required));
            return false;
        }
        ...
        if (TextUtils.isEmpty(strStock)) {
            ...
            mEditTextProductStock.setError(getString(R.string.error_quantity_required));
            return false;
        }
        ...
        if (TextUtils.isEmpty(supplier)) {
            ...
            mEditTextSupplier.setError(getString(R.string.error_supplier_name_required));
            return false;
        }
        ...
        if (TextUtils.isEmpty(supplierEmail) || (!Patterns.EMAIL_ADDRESS.matcher(supplierEmail).matches())) {
            ...
            mEditTextSupplierEmail.setError(getString(R.string.error_supplier_email_invalid));
            return false;
        }
